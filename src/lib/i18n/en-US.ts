export default {
  ...
  priority: {
    ...
    tooltip: {
      ...
      C: 'Regular Progress · Quota 3/cycle · 20-45 min · Standard difficulty',
  ...
  settings: {
    ...
    methodology: {
      ...
      priorities: {
        ...
        C: 'C (Regular Progress): 3 per cycle, regular work tasks, 20-45 min',
